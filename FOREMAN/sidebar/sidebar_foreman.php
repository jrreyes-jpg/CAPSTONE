...
?>
<link rel="stylesheet" href="/codesamplecaps/public/assets/css/sidebar_foreman.css">
<nav class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu">
        <li><a href="/codesamplecaps/views/dashboards/foreman_dashboard.php" class="menu-link<?php echo $isDashboard ? ' active' : ''; ?>">📊 <span class="menu-text">Dashboard</span></a></li>
...
<script src="/codesamplecaps/public/assets/js/sidebar_foreman.js"></script>