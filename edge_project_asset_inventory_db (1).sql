...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Mar 15, 2026 at 04:12 PM
...
(11, 'jhayreyes825@gmail.com', '::1', 1, '2026-03-10 14:59:41');
...
(14, 'Engineer2', 'Engineer2@gmail.com', '09070782511', '$2y$10$6n9a2JhT./x3UAawlr5kce.sLNAtiRHYKpzpJScEQNF4Ccuo9LGhC', 'engineer', 'active', 0, NULL, '2026-03-14 02:53:41', '2026-03-14 02:53:41', 5, NULL, NULL);
...
ALTER TABLE `asset_usage_logs`
  ADD CONSTRAINT `fk_usage_asset` FOREIGN KEY (`asset_id`) REFERENCES `assets` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_usage_foreman` FOREIGN KEY (`foreman_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;

ALTER TABLE `asset_scan_history`
  ADD CONSTRAINT `fk_scan_asset` FOREIGN KEY (`asset_id`) REFERENCES `assets` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_scan_foreman` FOREIGN KEY (`foreman_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
