...
<div class="container">
    ...
    <main class="main-content">
        ...
        <div id="users" class="tab-content <?php echo $isUserWorkspaceTab ? 'active' : ''; ?>" style="<?php echo $isUserWorkspaceTab ? 'display: block;' : 'display: none;'; ?>">
